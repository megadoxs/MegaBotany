...
public class BottledFlame extends BaubleItem implements INatureInfusable {
    ...
    public void appendHoverText(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flags) {
        ...
        tooltip.add(Component.translatable("misc.extrabotany_reborn.mode").append(": ").append(Component.translatable("misc.extrabotany_reborn.bottled_flame.mode." + ItemNBTHelper.getInt(stack, TAG_MODE, 0))));
    }
