...
public class CoreGod extends BaubleItem implements CustomCreativeTabContents {
    ...
    private static boolean shouldPlayerHaveFlight(Player player) {
        ItemStack armor = EquipmentHandler.findOrEmpty(ModItems.GOD_CORE.get(), player);
        if (!armor.isEmpty()) {
    ...
    public void appendHoverText(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flags) {
        ...
        tooltip.add(Component.translatable("misc.extrabotany_reborn.wings" + getVariant(stack)));
    }
    ...
    public static class Renderer implements AccessoryRenderer {
        ...
        private static void renderGodness(HumanoidModel<?> bipedModel, ItemStack stack, PoseStack ms, MultiBufferSource buffers, int light, float flap) {
            ...
            for(int i = 0; i < 2; ++i){
                ...
                Minecraft.getInstance().getItemRenderer().render(stack, ItemDisplayContext.NONE, false, ms, buffers, light, OverlayTexture.NO_OVERLAY, io.github.megadoxs.extrabotany_reborn.client.core.handler.MiscellaneousModels.INSTANCE.goddessWingIcons[i]);
                ms.popPose();
            }
        ...
        private static void renderElf(HumanoidModel<?> bipedModel, ItemStack stack, PoseStack ms, MultiBufferSource buffers, int light, float flap) {
            ...
            for(int i = 0; i < 2; ++i){
                for(int j = 0; j < io.github.megadoxs.extrabotany_reborn.client.core.handler.MiscellaneousModels.INSTANCE.elfWingIcons.length; j++){
                    ...
                    Minecraft.getInstance().getItemRenderer().render(stack, ItemDisplayContext.NONE, false, ms, buffers, light, OverlayTexture.NO_OVERLAY, io.github.megadoxs.extrabotany_reborn.client.core.handler.MiscellaneousModels.INSTANCE.elfWingIcons[j]);
                    ms.popPose();
                }
            }
            ...
            if (meta > 0) {
                ...
                switch (meta) {
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        model = io.github.megadoxs.extrabotany_reborn.client.core.handler.MiscellaneousModels.INSTANCE.flandreWingIcon;
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        model = io.github.megadoxs.extrabotany_reborn.client.core.handler.MiscellaneousModels.INSTANCE.steamPunkWingIcon;
                        renderBasicCore(bipedModel, model, stack, ms, buffers, light, flap, 0.05);
                        break;
                    case 14:
                        model = io.github.megadoxs.extrabotany_reborn.client.core.handler.MiscellaneousModels.INSTANCE.jimWingIcon;
                        renderBasicCore(bipedModel, model, stack, ms, buffers, light, flap, 0.15);
                        break;
                }
