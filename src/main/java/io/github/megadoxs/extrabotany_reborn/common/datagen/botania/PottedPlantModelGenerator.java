...
public class PottedPlantModelGenerator implements DataProvider {
    ...
    public CompletableFuture<?> run(CachedOutput cache) {
        ...
        for (Block b : ForgeRegistries.BLOCKS) {
            ...
            if (ExtraBotany_Reborn.MOD_ID.equals(blockId.getNamespace()) && b instanceof FlowerPotBlock) {
                ...
                textures.addProperty("plant", ExtraBotany_Reborn.MOD_ID + ":block/" + nonPotted);
