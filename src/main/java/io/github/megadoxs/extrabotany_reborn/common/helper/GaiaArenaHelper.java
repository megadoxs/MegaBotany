package io.github.megadoxs.extrabotany_reborn.common.helper;

import com.google.common.collect.ImmutableList;
import io.github.megadoxs.extrabotany_reborn.common.entity.GaiaGuardianIII;
...
public class GaiaArenaHelper {
    ...
    public static final List<String> mods = List.of("minecraft", "botania", "extrabotany_reborn"); // will have to be renamed do megabotany
