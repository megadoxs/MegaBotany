package io.github.megadoxs.extrabotany_reborn.client.core.handler;
...
@OnlyIn(Dist.CLIENT)
@Mod.EventBusSubscriber(modid = "extrabotany_reborn", bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class MiscellaneousModels {
    private static final ResourceLocation[] goddessWingIconIds = IntStream.range(1, 3).mapToObj((i) -> new ResourceLocation("extrabotany_reborn", ("icon/god_core_10_" + i))).toArray(ResourceLocation[]::new);
    private static final ResourceLocation[] elfWingIconIds = IntStream.range(1, 8).mapToObj((i) -> new ResourceLocation("extrabotany_reborn", ("icon/god_core_12_" + i))).toArray(ResourceLocation[]::new);
    private static final ResourceLocation flandreWingIconId = new ResourceLocation("extrabotany_reborn:icon/god_core_11");
    private static final ResourceLocation steamPunkWingIconId = new ResourceLocation("extrabotany_reborn:icon/god_core_13");
    private static final ResourceLocation jimWingIconId = new ResourceLocation("extrabotany_reborn:icon/god_core_14");
