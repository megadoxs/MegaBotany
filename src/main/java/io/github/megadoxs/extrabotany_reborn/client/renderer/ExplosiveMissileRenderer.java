package io.github.megadoxs.extrabotany_reborn.client.renderer;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import io.github.megadoxs.extrabotany_reborn.client.model.ModModelLayer;
import io.github.megadoxs.extrabotany_reborn.common.entity.Missile;
...
public class ExplosiveMissileRenderer extends EntityRenderer<Missile> {
    ...
    public ExplosiveMissileRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SkullModel(context.bakeLayer(ModModelLayer.EXPLOSIVE_MISSILE));
    }
...
//        }
        return new ResourceLocation("extrabotany_reborn", "textures/model/explosive_red.png");
    }
