...
public class NatureOrb extends BaubleItem implements CustomCreativeTabContents, INatureInfusable { //TODO rename to spirit orb and make the orb change color depending on the purity of the mana inside the orb
    ...
    public void appendHoverText(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flags) {
        ...
        tooltip.add(Component.translatable("misc.megabotany.natural_breath").withStyle(ChatFormatting.GRAY).append(": " + getNaturalBreath(stack) + "/" + MAX_NATURAL_BREATH));
        tooltip.add(Component.translatable("misc.megabotany.nature_orb_effect1").withStyle(ChatFormatting.GRAY).append(": ").append(Component.translatable(getNaturalBreath(stack) < 10000 ? "misc.megabotany.deactivated" : "misc.megabotany.activated").withStyle(ChatFormatting.AQUA)));
        tooltip.add(Component.translatable("misc.megabotany.nature_orb_effect2").withStyle(ChatFormatting.GRAY).append(": ").append(Component.translatable(getNaturalBreath(stack) < 30000 ? "misc.megabotany.deactivated" : "misc.megabotany.activated").withStyle(ChatFormatting.RED)));
        tooltip.add(Component.translatable("misc.megabotany.nature_orb_effect3").withStyle(ChatFormatting.GRAY).append(": ").append(Component.translatable(getNaturalBreath(stack) < 40000 ? "misc.megabotany.deactivated" : "misc.megabotany.activated").withStyle(ChatFormatting.GREEN)));
    }
