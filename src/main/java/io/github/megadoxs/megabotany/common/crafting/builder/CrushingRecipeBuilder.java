package io.github.megadoxs.megabotany.common.crafting.builder;
...
import static io.github.megadoxs.megabotany.common.crafting.MegaBotanyRecipes.CRUSHING_SERIALIZER;
...
public class CrushingRecipeBuilder implements RecipeBuilder {
    ...
    private static ResourceLocation getDefaultRecipeId(ItemLike item) {
        return new ResourceLocation("megabotany", "crushing/" + item.asItem());
    }
